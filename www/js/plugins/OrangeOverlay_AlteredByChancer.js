...
//============================================================================
  ...
  function resolveName(p_lyr, p_map) {

      let layerArg = $dataMap.meta[p_map];

      if(layerArg && typeof layerArg !== "boolean") {

          layerArg = layerArg.trim();

          if(!isNaN(layerArg) && layerArg.length <= 3) {
              return p_lyr + Number(layerArg);
          }

          return layerArg; // File name.
      }

      return p_lyr + $gameMap._mapId;
  }
...
//============================================================================
  var name = $.groundName || resolveName($.Param.groundLayerFileName, "ground");
...
// Chaucer : retain using the ground name if it still exists.
//============================================================================
    var name = $.parallaxName || resolveName($.Param.parallaxLayerFileName, "par");
...
//============================================================================
  var groundName = $.groundName || resolveName($.Param.groundLayerFileName, "ground");
//============================================================================
...
// Chaucer : addded check for new grond name.
//============================================================================
    var parallaxName = $.parallaxName || resolveName($.Param.parallaxLayerFileName, "par");
//============================================================================
